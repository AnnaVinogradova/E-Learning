 ...
 * @ORM\Entity(repositoryClass="ELearning\CompanyPortalBundle\Repository\HomeworkRepository")
 */
class Homework
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="ELearning\CompanyPortalBundle\Entity\Course", inversedBy="homeworks")
